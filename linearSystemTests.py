...
# reduced row echelon form (rref) form tests
p1 = Plane(normal_vector=Vector(['1','1','1']), constant_term='1')
p2 = Plane(normal_vector=Vector(['0','1','1']), constant_term='2')
s = LinearSystem([p1,p2])
r = s.compute_rref()
...
#print ("second system:  " + str(system2.compute_solution()))
#
## third system
...
#print ("thrid system:  " + str(system3.compute_solution()))
#    
...
system4 = LinearSystem([p1, p2])
print(system4.compute_solution())

p1 = Plane(Vector([8.631, 5.112, -1.816]), -5.113)
p2 = Plane(Vector([4.315, 11.132, -5.27]), -6.775)
p3 = Plane(Vector([-2.158, 3.01, -1.727]), -0.831)

system5 = LinearSystem([p1, p2, p3])
print(system5.compute_solution())
...
system6 = LinearSystem([p1, p2, p3, p4])
print(system6.compute_solution())
